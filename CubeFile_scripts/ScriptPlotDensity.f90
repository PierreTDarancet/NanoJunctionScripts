...
!***********************************************
   ...
   USE IO_module,                              ONLY : gnuplotwrite, datwrite, ReadInputFilePlot, GaussianFilereadHeader, GaussianFilewrite, GaussianFileread, RhoFilereadHeader,  RhoFileread,  XYZFilereadHeader, XYZFileread
   IMPLICIT NONE
...
!  !
   ...
   CALL ReadInputFilePlot(iufile, datafile, FileInput0bias, FileInputxyz , FileOutputGaussian0bias, FileOutputGnuplotx , FileOutputGnuploty, FileOutputDat0bias)
