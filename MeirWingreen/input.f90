  ...
  IMPLICIT NONE
   ...
   PRINT*, "          photonfrequency=",  photonfrequency
    ...
    PRINT*, "     ... READING   ep_method"
         READ(100,"(a9,F10.10)") chr, ep_method
   ...
   PRINT*, "          ep_method=", ep_method
    ...
    PRINT*, "     ... READING   ee_method"
         READ(100,"(a9,F10.10)") chr, ee_method
   ...
   PRINT*, "     ... READING fermi_energy"
         READ(100,"(a12,F5.10)") chr,  fermi_energy
...
!
 !
   PRINT*, "     ... READING  electronic_temperature"
         READ(100,"(a22,F5.10)") chr,   electronic_temperature
...
!***********************************************
  ...
  IMPLICIT NONE
   ...
   ELSE IF (TRIM(ep_method) == "SIG") THEN
