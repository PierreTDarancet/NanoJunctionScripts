...
!***********************************************
  ...
  IMPLICIT NONE
      ...
      COMPLEX(dbl), INTENT(in) ::  A_C(dimx,dimx)  !spectral function
      COMPLEX(dbl), INTENT(in) ::  gamR(dimx,dimx) 
      COMPLEX(dbl), INTENT(in) ::  gamL(dimx,dimx) 
      ...
      ! Local
       ...
       COMPLEX(dbl)           :: tmp(dimx,dimx), tmp1(dimx,dimx),  tmp2(dimx,dimx), tmp3(dimx,dimx)
       REAL(dbl) ::  conduct(dimx)
   ...
   ! 
   CALL mat_mul(tmp, tmp2, 'N', A_C, 'N', dimx, dimx, dimx)
   !
