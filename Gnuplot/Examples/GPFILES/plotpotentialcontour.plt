...
if (SETTITLE)   set title sprintf("%d mV",it)
...
#set cntr levels discrete -0.3
set contour base
set cntr levels incremental CBMIN, CONTOURINCREMENT, CBMAX 
set cntr bspline

set palette defined (CBMIN "blue", 0 "white", CBMAX "red")

splot INPUT_FILE u 2:1:($3*Scaling_factor_Z) w line palette
