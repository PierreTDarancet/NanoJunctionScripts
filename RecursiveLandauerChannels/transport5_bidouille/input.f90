...
!**********************************************************
   ...
   !**********************************************************
      ...
      USE T_input_parameters_module,ONLY : nprint_            => nprint, &
                                           ...
                                           in_datafile_CC_1_  => in_datafile_CC_1, &
                                           in_datafile_CC_2_  => in_datafile_CC_2, &
                                           in_max_iter_L_     => in_max_iter_L, &
                                           in_max_iter_R_     => in_max_iter_R, &
                                           in_iter_CC_2_      => in_iter_CC_2, &
                                           in_iter_CC_1_      => in_iter_CC_1, &
      ...
      in_iter_CC_1        = in_iter_CC_1_
      in_iter_CC_2        = in_iter_CC_2_
      in_datafile_CC_1    = in_datafile_CC_1_
      in_datafile_CC_2    = in_datafile_CC_2_
