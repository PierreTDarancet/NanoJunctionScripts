...
!
  ...
  PRINT*, "  ...Writing results"    
   ...
   IF ( ( print_current ) .OR. ( debug_level > 0 )) THEN
	   ...
	   DO ialpha = 1, nalpha
		DO ibias = 1, nbias
			Current(ialpha,ibias) = Current(ialpha,ibias) *77.480917*1000000.0  !!! nA
   ...
   ENDIF 
	   ...
	   DO ialpha = 1, nalpha
		DO ibias = 1, nbias
                        ...
                        Photocurrentmax_aux = MAXVAL(Photocurrent(:,ialpha,ibias) ) *77.480917*1000000.0
			Photocurrentmax(ialpha,ibias) = Photocurrentmax(ialpha,ibias) *77.480917*1000000.0  
	   ...
	   ENDDO
		   ...
		   DO ialpha = 1, nalpha
			DO ibias = 1, nbias
				Photocurrent(iph,ialpha,ibias) = Photocurrent(iph,ialpha,ibias) *77.480917 *1000000.0 !!! nA
