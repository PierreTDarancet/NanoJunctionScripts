...
!**********************************************************
   ...
   USE in_hamiltonian_module,  ONLY : hamiltonian_deallocate, ham_alloc => alloc
   USE T_gamma_module,         ONLY : gamma_deallocate, gamma_alloc => alloc
   ...
   IMPLICIT NONE
      ...
      IF ( gamma_alloc )    CALL gamma_deallocate()
      !
