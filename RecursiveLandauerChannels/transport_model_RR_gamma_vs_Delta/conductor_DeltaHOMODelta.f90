...
! 
   ...
   REAL(dbl)             :: cond_aux, current_aux, biasaux
!
!------------------------------
! main body
!------------------------------
!   !
   ...
   DO igamma=1, ngamma
	   ...
	   DO igap=1, ngap
                   ...
                   CALL Molecular_hamiltonian_init(h00_C, h_CR, h_LC, h_RC, h_CL, h00_L, h01_L, h00_R, h01_R, biasaux, gammagrid(igamma), gapgrid(igap), dimC, debug_level) !Add gap
                   !Initialization
		   ...
		   DO ie = 1, ne
			 ...
			 !
                         CALL occupation_function_init(f_L(ie) , f_R(ie), egrid(ie), biasaux, electronic_temperature) 
                         !
