...
!***********************************************
  ...
  USE constants, ONLY : ZERO, ONE, CZERO, CONE, CI,PI
   ...
   ! Public
  INTEGER,PARAMETER   ::   dimL_ref=1
  INTEGER,PARAMETER   ::   dimR_ref=1
  INTEGER   ::   dimC_ref
...
!***********************************************
   SUBROUTINE Molecular_hamiltonian_init(h00_C, h_CR, h_LC, h_RC, h_CL,  h00_L, h01_L, h00_R, h01_R, omega_max, bias, gamma_ratio, dimCaux, debug_level)  
   !***********************************************
...
!      REAL(dbl), INTENT(out)  :: elumo(INT(dimCaux/2))
      ...
      h_CR(:,:)  = h_CR_ref(1:dimCaux,1:dimRaux)  + alpha * (  h_LC_ref(1:dimLaux,1:dimCaux) - h_CR_ref(1:dimCaux,1:dimRaux) )
      h_LC(:,:)  = h_LC_ref(1:dimLaux,1:dimCaux)  + alpha * (  h_LC_ref(1:dimLaux,1:dimCaux) - h_LC_ref(1:dimCaux,1:dimRaux) )
