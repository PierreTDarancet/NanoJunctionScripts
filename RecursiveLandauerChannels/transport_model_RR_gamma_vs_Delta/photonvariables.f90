...
!***********************************************
   ...
   IMPLICIT NONE
	 ...
	 OPEN ( Fil, FILE='ehomo.dat', FORM='formatted' )
	   ...
	   DO ialpha = 1, nalpha
	      DO ibias = 1, nbias
	           WRITE (Fil, '(30(f15.9))' )  alphagrid(ialpha) , biasgrid(ibias) , ( ehomo(ialpha,ibias, i_dim2) , i_dim2=1, dimC )
	      ENDDO
              WRITE (Fil, '(2(e15.9))' )
	   ENDDO
        CLOSE( Fil )
	 ...
	 OPEN ( Fil, FILE='elumo.dat', FORM='formatted' )
	   ...
	   DO ialpha = 1, nalpha
	      DO ibias = 1, nbias
	           WRITE (Fil, '(30(f15.9))' )  alphagrid(ialpha) , biasgrid(ibias) , ( elumo(ialpha,ibias, i_dim2) , i_dim2=1, dimC)
	      ENDDO
              WRITE (Fil, '(2(e15.9))' )
	   ENDDO
        CLOSE( Fil )
	 OPEN ( Fil, FILE='ihomo.dat', FORM='formatted' )
	   ...
	   DO ialpha = 1, nalpha
	      DO ibias = 1, nbias
	           WRITE (Fil, '(30(I10))' )  ialpha ,ibias , (  ihomo(ialpha,ibias, i_dim), i_dim=1, dimC )
	      ENDDO
              WRITE (Fil, '(2(e15.9))' )
	   ENDDO
        CLOSE( Fil )
	 ...
	 OPEN ( Fil, FILE='ilumo.dat', FORM='formatted' )
	   ...
	   DO ialpha = 1, nalpha
	      DO ibias = 1, nbias
	           WRITE (Fil, '(30(I10))' )  ialpha , ibias , (  ilumo(ialpha,ibias, i_dim), i_dim=1, dimC)
	      ENDDO
              WRITE (Fil, '(2(e15.9))' )
	   ENDDO
        CLOSE( Fil )
