...
!**********************************************************
   ...
   IMPLICIT NONE
       ...
       DO ien = 1, ne
             !
             CALL iotk_write_dat(unit,"sigma"//TRIM(iotk_index(ien)), gamma_R_s(ien,13:16,13:16))
       ENDDO
...
!**********************************************************
   ...
   IMPLICIT NONE
       ...
       DO ien = 1, ne
             !
             CALL iotk_write_dat(unit,"sigma"//TRIM(iotk_index(ien)), sigma_R(ien,13:16,13:16))
       ENDDO
