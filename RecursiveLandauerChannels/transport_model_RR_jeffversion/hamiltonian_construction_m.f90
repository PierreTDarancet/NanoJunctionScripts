...
!***********************************************
   ...
   !***********************************************
      ...
      h_CR(1,1)  = sqrt( realaux / (ONE +  gamma_ratio) )
      h_LC(1,1)  =  sqrt( realaux / (ONE +  (ONE/gamma_ratio) ) )
      realaux = h_CR_ref(2,1)**2 +  h_LC_ref(1,2)**2
      h_CR(2,1)  = sqrt( realaux / (ONE +  (ONE/gamma_ratio) ) )
      h_LC(1,2)  =  sqrt( realaux / (ONE + gamma_ratio) )
