...
!***********************************************
   SUBROUTINE calcul_g_greater( ggreater , sigma_l , sigma_r , sigma_c , gC , dimC)
   !***********************************************
  ...
  IMPLICIT NONE
      ...
      COMPLEX(dbl), INTENT(out) ::  ggreater(dimC,dimC) 
      ...
      ! Local
       ...
       COMPLEX(dbl) ::  work2(dimC,dimC)
         ...
         !
         CALL mat_mul( ggreater, work, 'N', gC, 'C', dimC, dimC, dimC)
         !
         !
    END SUBROUTINE calcul_g_greater
  ...
  IMPLICIT NONE
      ...
      ! Local
       ...
       COMPLEX(dbl) ::  work2(dimC,dimC)
         ...
         DO idiag = 1, dimC
             work1(idiag,idiag)= CONE * ene
             g_C(idiag,idiag)= CONE 
         ENDDO
         !
         work2(:,:) = work1(:,:) - h_00(:,:) -  sigma_l(:,:) - sigma_r(:,:) - sigma_c(:,:)
         !
         ! g_C^r
