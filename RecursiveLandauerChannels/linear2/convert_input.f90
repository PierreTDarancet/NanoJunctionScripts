...
!**********************************************************
   SUBROUTINE convert_input_manager()
   !**********************************************************
      USE convert_input_parameters_module,  ONLY :convert_read_namelist_control

     IMPLICIT NONE
      INTEGER :: ierr
      CHARACTER(21) :: subname='convert_input_manager'
      ...
      CALL convert_read_namelist_control(stdin)
      ...
      !
      CALL convert_setup_control()
      CALL convert_setup_io()
      !CALL convert_setup_dim()
      !CALL convert_setup_subspace()


   END SUBROUTINE convert_input_manager

!**********************************************************
   SUBROUTINE convert_setup_control()
   !**********************************************************
      USE convert_control_variable_module,     ONLY :    out_datafile_C, out_datafile_L, out_datafile_R, &
                                                         in_datafile_L, in_datafile_R, &
                                                         dim_subspace, &
                                                         n_iter_R, n_iter_L
      USE convert_input_parameters_module, ONLY :   out_datafile_C_ => out_datafile_C, &
   ...
   END SUBROUTINE convert_setup_control
! 
! !**********************************************************
...
!**********************************************************
   ...
   !**********************************************************
      ...
      work_dir = work_dir_
      title    = title_
   END SUBROUTINE convert_setup_io


END MODULE convert_input_module
