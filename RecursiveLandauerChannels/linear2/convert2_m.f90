...
!*********************************************
   ...
   !USE parser_module
   USE iotk_module
   USE convert2_control_variable_module,      ONLY : out_datafile_C, &
                                            out_datafile_L, &
                                            out_datafile_R, &
                                            in_datafile_L, &
                                            in_datafile_R, &
   ...
   ! general functions
   PUBLIC :: matrix2_allocate
   PUBLIC :: matrix2_deallocate
   PUBLIC :: print2_want
   PUBLIC :: read2_matrix
   PUBLIC :: build2_hamiltonian
   PUBLIC :: build2_matrix
   PUBLIC :: convert2_summary_input
...
!*******************************************************************
   SUBROUTINE matrix2_allocate
   !*******************************************************************
      CHARACTER(16)      :: subname="matrix2_allocate"
      INTEGER :: ierr
...
END SUBROUTINE matrix2_allocate

!**********************************************************
   SUBROUTINE matrix2_deallocate()
   !**********************************************************
   IMPLICIT NONE
      CHARACTER(18)      :: subname="matrix2_deallocate"
      INTEGER :: ierr
   ...
   END SUBROUTINE matrix2_deallocate


!*******************************************************************
   SUBROUTINE build2_hamiltonian
   !*******************************************************************
       CHARACTER(18)      :: subname="build2_hamiltonian"
       INTEGER :: icols, irows 
       INTEGER :: iter
     ...
     DO iter=2,range_iter
      DO icols=1, dim_subspace
         ...
         DO irows=1, dim_subspace
            ...
            final_hamiltonian_L(irows_shift,icols_shift)=B_matrix(iter,irows,icols)
            final_hamiltonian_L(icols_shift,irows_shift)=CONJG(B_matrix(iter,irows,icols))
            !
         ENDDO
      ENDDO
     ENDDO
     ...
     DO iter=1,range_iter
      DO icols=1, dim_subspace
         ...
         DO irows=1, dim_subspace
            ...
            !
            final_hamiltonian_L(irows_shift,icols_shift)=A_matrix(iter,irows,icols)
            !
         ENDDO
      ENDDO
     ENDDO
  ...
  END SUBROUTINE build2_hamiltonian


!*******************************************************************
   SUBROUTINE build2_matrix
   !*******************************************************************
     ...
     ! starting from the knowledge of the A/B_matrix_L/R read from recursion's files
       CHARACTER(13)      :: subname="build2_matrix"
...
!             ENDDO
   ...
   END SUBROUTINE build2_matrix



!**********************************************************
   SUBROUTINE print2_want
   !**********************************************************
   IMPLICIT NONE
   ...
   END SUBROUTINE print2_want


!*******************************************************************
   SUBROUTINE read2_matrix
   !*******************************************************************
       CHARACTER(12)      :: subname="read2_matrix"
  ...
  END SUBROUTINE read2_matrix

!**********************************************************
   SUBROUTINE convert2_summary_input
   !**********************************************************
   ! 
...
!          ENDIF
   ...
   END SUBROUTINE convert2_summary_input





 END MODULE convert2_module
