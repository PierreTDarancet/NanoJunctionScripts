...
!**********************************************************
   SUBROUTINE convert2_input_manager()
   !**********************************************************
      USE convert2_input_parameters_module,  ONLY :convert2_read_namelist_control

     IMPLICIT NONE
      INTEGER :: ierr
      CHARACTER(22) :: subname='convert2_input_manager'
      ...
      CALL convert2_read_namelist_control(stdin)
      ...
      !
      CALL convert2_setup_control()
      CALL convert2_setup_io()
      !CALL convert_setup_dim()
      !CALL convert_setup_subspace()


   END SUBROUTINE convert2_input_manager

!**********************************************************
   SUBROUTINE convert2_setup_control()
   !**********************************************************
      USE convert2_control_variable_module,     ONLY :    out_datafile_C, out_datafile_L, out_datafile_R, &
                                                         in_datafile_L, in_datafile_R, &
                                                         dim_subspace, &
                                                         n_iter_R, n_iter_L, &
                                                         out_iter_R, out_iter_L, &
                                                         out_iter_C
      USE convert2_input_parameters_module, ONLY :   out_datafile_C_ => out_datafile_C, &
   ...
   END SUBROUTINE convert2_setup_control
! 
! !**********************************************************
...
!**********************************************************
   ...
   !**********************************************************
      ...
      work_dir = work_dir_
      title    = title_
   END SUBROUTINE convert2_setup_io


END MODULE convert2_input_module
