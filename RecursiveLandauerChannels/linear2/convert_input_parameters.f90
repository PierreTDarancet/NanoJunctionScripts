...
!********************************************
   MODULE convert_input_parameters_module
!********************************************
   USE kinds,         ONLY : dbl
...
!
   ...
   NAMELIST / CONTROL /    title, prefix, postfix, work_dir, out_datafile_C, &
                           ...
                           n_iter_L, n_iter_R, dim_subspace
   ...
   PUBLIC ::  convert_read_namelist_control


CONTAINS

!**********************************************************
   SUBROUTINE convert_read_namelist_control(unit)
   !**********************************************************
   !
   ...
   IMPLICIT NONE
      ...
      CHARACTER(29) :: subname='convert_read_namelist_control'
      INTEGER :: ios
   ...
   END SUBROUTINE convert_read_namelist_control


END MODULE convert_input_parameters_module
