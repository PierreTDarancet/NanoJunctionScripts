...
!********************************************
   MODULE convert2_input_parameters_module
!********************************************
   USE kinds,         ONLY : dbl
...
!
   ...
   PUBLIC ::  convert2_read_namelist_control


CONTAINS

!**********************************************************
   SUBROUTINE convert2_read_namelist_control(unit)
   !**********************************************************
   !
   ...
   IMPLICIT NONE
      ...
      CHARACTER(30) :: subname='convert2_read_namelist_control'
      INTEGER :: ios
   ...
   END SUBROUTINE convert2_read_namelist_control


END MODULE convert2_input_parameters_module
