...
!********************************************
   MODULE convert3_input_parameters_module
!********************************************
   USE kinds,         ONLY : dbl
...
!
   ...
   PUBLIC ::  convert3_read_namelist_control


CONTAINS

!**********************************************************
   SUBROUTINE convert3_read_namelist_control(unit)
   !**********************************************************
   !
   ...
   IMPLICIT NONE
      ...
      CHARACTER(30) :: subname='convert3_read_namelist_control'
      INTEGER :: ios
   ...
   END SUBROUTINE convert3_read_namelist_control


END MODULE convert3_input_parameters_module
