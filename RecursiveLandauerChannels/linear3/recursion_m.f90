...
!     ENDDO
    ...
    SELECT CASE( TRIM(calculation_mode) )
     ...
     !
      ...
      !print*, recursion_state(1,:,:)
       ...
       CASE ("change_V")
            CALL calculate_recursion_state(nb_first, id_first, ene_onsite, ene_first, recursion_state_0(:,:), A_matrix_0(:,:), &
     ...
     !
       ...
       CASE ("diagonal_A")
            CALL calculate_recursion_state_diag_A(nb_first, id_first, ene_onsite, ene_first, recursion_state_0(:,:), A_matrix_0(:,:), &
                                aux1(:,:), aux2(:,:), recursion_state(1,:,:), B_matrix_0(:,:), norm(1), numerical_cut_off, debug_mode )

      !
       CASE ("diag_A_cond_V")
            CALL calculate_recursion_state_diag_A_rpp(nb_first, id_first, ene_onsite, ene_first, recursion_state_0(:,:), A_matrix_0(:,:), &
                                aux1(:,:), aux2(:,:), recursion_state(1,:,:), B_matrix_0(:,:), norm(1), numerical_cut_off, debug_mode )

      !
       CASE ("diag_A_sum_B")
            CALL calculate_recursion_state_diag_A_sum_B(nb_first, id_first, ene_onsite, ene_first, recursion_state_0(:,:), A_matrix_0(:,:), &
                                aux1(:,:), aux2(:,:), recursion_state(1,:,:), B_matrix_0(:,:), norm(1), numerical_cut_off, debug_mode )
      !
       CASE ("diag_A_sgn_B")
            CALL calculate_recursion_state_diag_A_sgn_B(nb_first, id_first, ene_onsite, ene_first, recursion_state_0(:,:), A_matrix_0(:,:), &
                                aux1(:,:), aux2(:,:), recursion_state(1,:,:), B_matrix_0(:,:), norm(1), numerical_cut_off, debug_mode )
      !
       CASE ("diag_B_B_dagger")
            CALL calculate_recursion_state_diag_B_B_dagger(nb_first, id_first, ene_onsite, ene_first, recursion_state_0(:,:), A_matrix_0(:,:), &
                                aux1(:,:), aux2(:,:), recursion_state(1,:,:), B_matrix_0(:,:), norm(1), numerical_cut_off, debug_mode )
      !
    ...
    !PRINT*, 'Fin, normalize_recursion state 1'
     ...
     ENDDO
     !
     CALL calculate_A_matrix(nb_first, id_first, ene_onsite, ene_first, recursion_state(1,:,:) ,  A_matrix(1,:,:), debug_mode ) 
     !

    SELECT CASE( TRIM(calculation_mode) )
       CASE ("no_condition")
     !
           CALL calculate_recursion_state(nb_first, id_first, ene_onsite, ene_first,  recursion_state(1,:,:), A_matrix(1,:,:), B_matrix_0(:,:), &
                                            recursion_state_0(:,:), recursion_state(2,:,:), debug_mode )
     !
          CALL normalize_recursion_state( recursion_state(2,:,:),  B_matrix(1,:,:), norm(2), numerical_cut_off, debug_mode  )
     !
       CASE ("change_V")
            CALL calculate_recursion_state(nb_first, id_first, ene_onsite, ene_first, recursion_state(1,:,:), A_matrix(1,:,:), &
     ...
     !
       CASE ("diagonal_A")
            CALL calculate_recursion_state_diag_A(nb_first, id_first, ene_onsite, ene_first, recursion_state(1,:,:), A_matrix(1,:,:), &
                         B_matrix_0(:,:), recursion_state_0(:,:), recursion_state(2,:,:),  B_matrix(1,:,:), norm(2), numerical_cut_off, debug_mode  )
     !
       CASE ("diag_A_cond_V")
            CALL calculate_recursion_state_diag_A_rpp(nb_first, id_first, ene_onsite, ene_first, recursion_state(1,:,:), A_matrix(1,:,:), &
                         B_matrix_0(:,:), recursion_state_0(:,:), recursion_state(2,:,:),  B_matrix(1,:,:), norm(2), numerical_cut_off, debug_mode  )
      !
       CASE ("diag_A_sum_B")
            CALL calculate_recursion_state_diag_A_sum_B(nb_first, id_first, ene_onsite, ene_first, recursion_state(1,:,:), A_matrix(1,:,:), &
                         B_matrix_0(:,:), recursion_state_0(:,:), recursion_state(2,:,:),  B_matrix(1,:,:), norm(2), numerical_cut_off, debug_mode  )
      !
       CASE ("diag_A_sgn_B")
            CALL calculate_recursion_state_diag_A_sgn_B(nb_first, id_first, ene_onsite, ene_first, recursion_state(1,:,:), A_matrix(1,:,:), &
                         B_matrix_0(:,:), recursion_state_0(:,:), recursion_state(2,:,:),  B_matrix(1,:,:), norm(2), numerical_cut_off, debug_mode  )
      !
       CASE ("diag_B_B_dagger")
            CALL calculate_recursion_state_diag_B_B_dagger(nb_first, id_first, ene_onsite, ene_first, recursion_state(1,:,:), A_matrix(1,:,:), &
                         B_matrix_0(:,:), recursion_state_0(:,:), recursion_state(2,:,:),  B_matrix(1,:,:), norm(2), numerical_cut_off, debug_mode  )
      !
     ...
     CALL summary_recursion_input(stdout, A_matrix_0, B_matrix_0, recursion_state_0, &
...
!
  ...
  DO iter = 1, max_iter-1
     ...
     iteration = iter+1
     !
     CALL calculate_A_matrix(nb_first, id_first, ene_onsite, ene_first, recursion_state(iteration,:,:) , A_matrix(iteration,:,:), debug_mode ) 
     !
     !
     SELECT CASE( TRIM(calculation_mode) )
       CASE ("no_condition")
            CALL calculate_recursion_state(nb_first, id_first, ene_onsite, ene_first, recursion_state(iteration,:,:), A_matrix(iteration,:,:), &
     ...
     !
       ...
       CASE ("diagonal_A")
            CALL calculate_recursion_state_diag_A(nb_first, id_first, ene_onsite, ene_first, recursion_state(iteration,:,:), A_matrix(iteration,:,:), &
     ...
     !
       CASE ("diag_A_cond_V")
            CALL calculate_recursion_state_diag_A_rpp(nb_first, id_first, ene_onsite, ene_first, recursion_state(iteration,:,:), A_matrix(iteration,:,:), &
                         B_matrix(iteration-1,:,:), recursion_state(iteration-1,:,:), recursion_state(iteration+1,:,:), &
                         B_matrix(iteration,:,:), norm(iteration+1), numerical_cut_off, debug_mode )
     !
       CASE ("diag_A_sum_B")
            CALL calculate_recursion_state_diag_A_sum_B(nb_first, id_first, ene_onsite, ene_first, recursion_state(iteration,:,:), A_matrix(iteration,:,:), &
                         B_matrix(iteration-1,:,:), recursion_state(iteration-1,:,:), recursion_state(iteration+1,:,:), &
                         B_matrix(iteration,:,:), norm(iteration+1), numerical_cut_off, debug_mode )
     !
       CASE ("diag_A_sgn_B")
            CALL calculate_recursion_state_diag_A_sgn_B(nb_first, id_first, ene_onsite, ene_first, recursion_state(iteration,:,:), A_matrix(iteration,:,:), &
                         B_matrix(iteration-1,:,:), recursion_state(iteration-1,:,:), recursion_state(iteration+1,:,:), &
                         B_matrix(iteration,:,:), norm(iteration+1), numerical_cut_off, debug_mode )
     !
       CASE ("diag_B_B_dagger")
            CALL calculate_recursion_state_diag_B_B_dagger(nb_first, id_first, ene_onsite, ene_first, recursion_state(iteration,:,:), A_matrix(iteration,:,:), &
                         B_matrix(iteration-1,:,:), recursion_state(iteration-1,:,:), recursion_state(iteration+1,:,:), &
                         B_matrix(iteration,:,:), norm(iteration+1), numerical_cut_off, debug_mode )
     !
