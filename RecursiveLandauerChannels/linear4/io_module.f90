...
!
   ...
   CHARACTER(4), PARAMETER    ::  suffix_wannier_center=".cen"
   CHARACTER(4), PARAMETER    ::  suffix_matrix=".mat"
   CHARACTER(4), PARAMETER    ::  suffix_states=".sta"
   CHARACTER(8), PARAMETER    ::  suffix_var="_var.dat"
   CHARACTER(10), PARAMETER   ::  suffix_A="_A_sum.dat"
   CHARACTER(10), PARAMETER   ::  suffix_B="_B_sum.dat"
   CHARACTER(8), PARAMETER    ::  suffix_overlap=".overlap"
   CHARACTER(5), PARAMETER    ::  suffix_dist=".dist"
   CHARACTER(4), PARAMETER    ::  suffix_orb=".orb"
...
!**********************************************************
   ...
   !**********************************************************
      ...
      CASE ( "wannier_center" )
           suffix_ = TRIM(suffix_wannier_center)
      CASE ( "matrix" )
           suffix_ = TRIM(suffix_matrix)
      CASE ( "states" )
           suffix_ = TRIM(suffix_states)
      CASE ( "variation" )
           suffix_ = TRIM(suffix_var)
      CASE ( "A_sum" )
           suffix_ = TRIM(suffix_A)
      CASE ( "B_sum" )
           suffix_ = TRIM(suffix_B)
      CASE ( "overlap" )
           suffix_ = TRIM(suffix_overlap)
      CASE ( "distance" )
           suffix_ = TRIM(suffix_dist)
      CASE ( "orbital" )
           suffix_ = TRIM(suffix_orb)
